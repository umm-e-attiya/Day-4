...
const Section1 = ({params}: param) =>{
    ...
    const section2find = section2.find((items) => items.id === convertNumber) 
    ...
    return(
          <div className="lg:mx-36 mt-10">
              ...
              {section2find &&
                 ...
                 <Image src={section2find?.image || "/noting"} alt="not-found" width={444} height={530} className="lg:w-[444px] mx-6 lg:h-[530px] w-[300px] rounded-[20px]" />
                  <div>
                   <h1 className="font-bold lg:text-[40px]">{section2find?.title}</h1>
                   <div className="lg:flex">
                   <Image src={section2find?.starimage || "/noting"} alt="not-found" width={139} height={24}  />
                    <div>
                     <p className="text-[16px] gap-3">{section2find?.review}</p>
                    </div>
                   </div>
                    <div className="flex gap-4">
                     <p className="font-bold text-[32px]">{section2find?.price}</p>
                     <div>
                       <p className="font-bold text-[32px] line-through text-gray-400">{section2find?.discountedprice}</p>
                     </div>
                     <div>
                       <p className="bg-red-300 text-[16px] font-medium mt-2 text-red-500 rounded-[62px]">{section2find?.sale}</p>
                     </div>

                    </div>
                    <div>
                     <p className="font-normal text-gray-500 text-[16px] lg:w-[590px]">{section2find?.description}</p>
                   </div>
            ...
            >
             ...
             <div className="lg:flex whitespace-nowrap mt-6 gap-4 ">
              <div>
              <p className="font-normal text-[20px] lg:ml-40  text-gray-400">Product Details</p>
              <hr className="lg:w-[400px] w-[300px] bg-gray-400 border-[1px]" />
              </div>
              <div>
              <p className="font-medium text-[20px] lg:ml-40 text-black">Rating & Review</p>
              <hr className="lg;w-[400px] w-[300px] text-black border-[2px] hover:bg-black" />
              </div>
              <div>
              <p className="font-normal text-[20px] lg:ml-40 text-gray-400">FAQs</p>
              <hr className="lg:w-[400px] w-[300px] bg-gray-400 border-[1px]" />
              </div>
            </div>
            <div className="lg:flex">
              <div className="flex gap-5 mt-4">
                 ...
                 <div className="flex lg:ml-[60%] gap-5 mt-4">
