  ...
  return (
    <div>
      ...
      <div className="bg-black w-full flex items-center justify-between px-9 lg:px-14 lg:py-3">
        ...
        <Image src={vector} alt="vector" className="hidden  w-[20px] h-[20px]" />
      </div>
      ...
      <div className="flex items-center justify-between bg-white mt-4 lg:mt-6 px-4 md:px-7 lg:px-14">
        ...
        <Sheet>
          ...
          <SheetContent className="bg-white">
            <Image src={searchbar} alt="searchbar" className="w-[250px] h-[47px]" />
        ...
        <div className="hidden lg:flex lg:ml-auto">
          <Image src={searchbar} alt="searchbar" className="w-[577px] h-[48px]" />
        </div>
...
>>>>>>> 5937e95355ab4866101657bfa4f78558e63d9d41
