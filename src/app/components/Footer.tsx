...
const Footer = () => {
    return (
        <div>
            ...
            <div className=" w-full h-[250px] lg:h-[180px]  bg-black mt-20  rounded-[20px]">
                               <div className="lg:flex">
                                    <div>
                                      <h1 className="lg:w-[551px] h-[94px] font-bold lg:text-[40px] text-white lg:ml-20 mt-10 ">STAY UPTO DATE ABOUT OUR LATEST OFFERS</h1>
                                    </div>
                                     <div>
                                     <div className="lg:w-[349px] h-[48px] w-[300px] rounded-[62px] bg-white mt-10 lg:ml-16 pt-[12px] pb-[12px] pl-[20px] flex">
                                     <HiOutlineMail className="mt-1" />
                                      <p className="w-[300px] h-[22px] font-normal text-[16px] text-gray-500 "> Enter your email address</p>
                                     </div>
                                      <div className="lg:w-[349px] h-[48px] w-[300px] rounded-[62px] bg-white mt-3 lg:ml-16  pt-[12px] pb-[12px] pl-[20px]">
                ...
                <div className="bg-gray-200 w-full   lg:h-[499px]">
                    <div className="lg:flex lg:flex-row ">
                        ...
                        <div className="mt-40">
                        <p className="font-medium text-[16px] text-black lg:ml-20">Company</p>
                        <ul className="text-[16px] font-normal lg:ml-20 text-gray-500">
                       ...
                       <div className="mt-40">
                        <p className="font-medium text-[16px] text-black lg:ml-20">Help</p>
                        <ul className="text-[16px] font-normal lg:ml-20 text-gray-500">
                       ...
                       <div className="mt-40">
                        <p className="font-medium text-[16px] text-black lg:ml-20">FAQ</p>
                        <ul className="text-[16px] font-normal lg:ml-20 text-gray-500">
                       ...
                       <div className="mt-40">
                        <p className="font-medium text-[16px] text-black lg:ml-20">Resources</p>
                        <ul className="text-[16px] font-normal lg:ml-20 text-gray-500">
                     ...
                     <hr className="lg:w-[500px] w-[300px]  lg:ml-32  "/>

                     <div className="mt-16 lg:flex">
                        <p className="text-gray-400 lg:ml-20">Shop.co © 2000-2023, All Rights Reserved</p>
                        <div className="flex gap-3  lg:ml-[900px]">
